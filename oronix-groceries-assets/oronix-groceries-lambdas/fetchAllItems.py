...
def lambda_handler(event, context):
    try:
        ...
        return response_with_cors(200, "Items fetched successfully", convert_decimals(items))
    except Exception as e:
        return response_with_cors(500, "Failed to fetch items", str(e))
